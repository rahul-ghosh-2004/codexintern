...
function ApplyIntern() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.href = "https://chat.whatsapp.com/IjrdMzkBjmC5C142dHkdjo"
    } catch (error) {
      setLoadingStatus(false)
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center max-w-lg mx-auto px-4 space-y-6 font-[sans-serif] text-[#333]">
      ...
      <a href="https://chat.whatsapp.com/IjrdMzkBjmC5C142dHkdjo" target='_blank'>
      ...
      <div class="space-x-6 space-y-4 text-center m-4">
        ...
        <Link to={"https://chat.whatsapp.com/IjrdMzkBjmC5C142dHkdjo"}>
          <button type="button"

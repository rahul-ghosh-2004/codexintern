...
const ContactUs = () => {
  return (
    <div class="grid sm:grid-cols-2 items-start gap-16 p-4 mt-24 mb-24 mx-auto max-w-4xl bg-white font-[sans-serif]">
            <div>
                ...
                <div class="mt-5">
                    <h2 class="text-gray-800 text-base font-bold">Contact</h2>
                    <ul class="mt-4">
                        <li class="flex items-center">
                            <a href="javascript:void(0)" class="text-[#007bff] text-sm ml-4">
